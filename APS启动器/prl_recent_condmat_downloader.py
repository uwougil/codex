...
def parse_args() -> argparse.Namespace:
    default_profile = Path(tempfile.gettempdir()) / "aps_scrapling_profile"

    parser = argparse.ArgumentParser(
        description=(
            "Download recent condensed-matter PDFs across APS journals "
            "by combining official recent sections, APS PhySH, and "
            "rule-based title/abstract filtering."
        )
    )
    parser.add_argument(
        "--days",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Other APS journals use journal scope or APS PhySH matching."
        ),
    )
    parser.add_argument(
        "--sources",
        ...
        default="aps",
        help=(
            "Comma-separated sources to scan. Supported values: aps. Default: aps"
        ),
    )
    parser.add_argument(
        "--parallel-sites",
        action="store_true",
        help=(
            "Enable parallel search across APS journals using separate browser profiles."
        ),
    )
    parser.add_argument(
        "--headless",
